/*******************************************************************************
* File Name: Ultrasonic_Pulse_Counter.c
* Version 1.0
*
* Description:
...
uint8 Ultrasonic_Pulse_Counter_initVar = 0u;


/*******************************************************************************
* Function Name: Ultrasonic_Pulse_Counter_Init
********************************************************************************
*
* Summary:
...
void Ultrasonic_Pulse_Counter_Init(void) 
{
    ...
    Ultrasonic_Pulse_Counter_PERIOD_REG = Ultrasonic_Pulse_Counter_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: Ultrasonic_Pulse_Counter_Enable
********************************************************************************
*
* Summary:
...
void Ultrasonic_Pulse_Counter_Enable(void) 
{
    ...
    */
    Ultrasonic_Pulse_Counter_AUX_CONTROL_REG |= Ultrasonic_Pulse_Counter_COUNTER_START;
...
/*******************************************************************************
* Function Name: Ultrasonic_Pulse_Counter_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  Ultrasonic_Pulse_Counter_initVar - global variable.
*
* Return:
*  None.
*
...
void Ultrasonic_Pulse_Counter_Start(void) 
{
    ...
    if(Ultrasonic_Pulse_Counter_initVar == 0u)
    {
        Ultrasonic_Pulse_Counter_Init();
        Ultrasonic_Pulse_Counter_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: Ultrasonic_Pulse_Counter_Stop
********************************************************************************
*
* Summary:
...
void Ultrasonic_Pulse_Counter_Stop(void) 
{
    ...
    Ultrasonic_Pulse_Counter_AUX_CONTROL_REG &= (uint8) ~((uint8) Ultrasonic_Pulse_Counter_COUNTER_START);
...
/*******************************************************************************
* Function Name: Ultrasonic_Pulse_Counter_WriteCounter
********************************************************************************
*
* Summary:
...
{
    Ultrasonic_Pulse_Counter_COUNT_REG = (count & Ultrasonic_Pulse_Counter_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: Ultrasonic_Pulse_Counter_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(Ultrasonic_Pulse_Counter_COUNT_REG & Ultrasonic_Pulse_Counter_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: Ultrasonic_Pulse_Counter_WritePeriod
********************************************************************************
*
* Summary:
...
{
    Ultrasonic_Pulse_Counter_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: Ultrasonic_Pulse_Counter_ReadPeriod
********************************************************************************
*
* Summary:
...
{
    return(Ultrasonic_Pulse_Counter_PERIOD_REG);
}
